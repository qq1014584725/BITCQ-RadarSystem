...
parser.add_argument('--save_dir', type=str, default='checkpoints/bitcq_pfst_convlstm')
parser.add_argument('--gen_frm_dir', type=str, default='test/bitcq_pfst_convlstm/')
...
# model
parser.add_argument('--model_name', type=str, default='pfst_convlstm')
parser.add_argument('--model_type', type=str, default='ef')
parser.add_argument('--pretrained_model', type=str, default='')
parser.add_argument('--patch_size', type=int, default=1)
parser.add_argument('--num_hidden', type=str, default='256, 256, 256')
...
# use
parser.add_argument('--temp_frm_dir', type=str, default='temp/bitcq_pfst_convlstm/')
