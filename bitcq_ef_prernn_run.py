...
parser.add_argument('--save_dir', type=str, default='checkpoints/bitcq_ef_prernn')
parser.add_argument('--gen_frm_dir', type=str, default='test/bitcq_ef_prernn/')
...
# model
parser.add_argument('--model_name', type=str, default='ef_prernn')
...
# use
parser.add_argument('--temp_frm_dir', type=str, default='temp/bitcq_ef_prernn/')
