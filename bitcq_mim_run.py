...
import math
# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch video prediction model - EF_MIM')
...
parser.add_argument('--save_dir', type=str, default='checkpoints/bitcq_ef_mim')
parser.add_argument('--gen_frm_dir', type=str, default='test/bitcq_ef_mim/')
...
# model
parser.add_argument('--model_name', type=str, default='ef_mim')
...
# use
parser.add_argument('--temp_frm_dir', type=str, default='temp/bitcq_ef_mim/')
