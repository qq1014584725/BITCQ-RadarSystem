...
parser.add_argument('--save_dir', type=str, default='checkpoints/bitcq_inter_dst_predrnn_r4')
parser.add_argument('--gen_frm_dir', type=str, default='/mnt/A/meteorological/2500_ref_seq/CIKM_inter_dst_predrnn_r4_/')
