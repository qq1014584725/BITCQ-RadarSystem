...
parser.add_argument('--save_dir', type=str, default='checkpoints/bitcq_predrnn')
parser.add_argument('--gen_frm_dir', type=str, default='test/CIKM_predrnn/')
...
parser.add_argument('--model_type', type=str, default='seq')
parser.add_argument('--pretrained_model', type=str, default='')
parser.add_argument('--num_hidden', type=str, default='64,64,64')
...
def wrapper_test(model):
    ...
    while flag:
        ...
        img_out = unpadding_Jiangsu_data(img_out)
        loss = loss + mse
        count = count + 1
        ...
        for ind in range(index - batch_size, index, 1):
            ...
            for t in range(11, 31, 1):
                imsave(save_fold + 'img_' + str(t) + '.png', img_out[bat_ind, t - 11, :, :, 0])
            bat_ind = bat_ind + 1
