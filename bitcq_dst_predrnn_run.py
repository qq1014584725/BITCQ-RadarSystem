...
import math
# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch video prediction model - DST PredRNN')
...
parser.add_argument('--save_dir', type=str, default='checkpoints/bitcq_dst_predrnn')
parser.add_argument('--gen_frm_dir', type=str, default='/mnt/A/meteorological/2500_ref_seq/CIKM_dst_predrnn/')
...
# model
parser.add_argument('--model_name', type=str, default='dst_predrnn')
