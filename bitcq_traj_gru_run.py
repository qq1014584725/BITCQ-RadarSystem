...
parser.add_argument('--save_dir', type=str, default='checkpoints/bitcq_traj_gru')
parser.add_argument('--gen_frm_dir', type=str, default='test/bitcq_traj_gru/')
...
# model
parser.add_argument('--model_name', type=str, default='traj_gru')
...
# use
parser.add_argument('--temp_frm_dir', type=str, default='temp/bitcq_traj_gru/')
