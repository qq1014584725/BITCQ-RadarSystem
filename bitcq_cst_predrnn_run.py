...
import math
# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch video prediction model - CST PredRNN')
...
parser.add_argument('--save_dir', type=str, default='checkpoints/bitcq_cst_predrnn')
parser.add_argument('--gen_frm_dir', type=str, default='/mnt/A/meteorological/2500_ref_seq/CIKM_cst_predrnn/')
...
# model
parser.add_argument('--model_name', type=str, default='cst_predrnn')
