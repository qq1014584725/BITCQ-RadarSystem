...
import math
# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch video prediction model - Interaction PredRNN')
...
parser.add_argument('--save_dir', type=str, default='checkpoints/bitcq_predrnn_r4')
parser.add_argument('--gen_frm_dir', type=str, default='/mnt/A/meteorological/2500_ref_seq/CIKM_predrnn_r4/')
...
# model
parser.add_argument('--model_name', type=str, default='interact_predrnn')
